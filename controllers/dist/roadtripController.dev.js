...
var RoadTrip = require("../models/roadtrip");
...
var getRoadTripParams = function getRoadTripParams(body) {
  return {
...
module.exports = {
  ...
  create: function create(req, res, next) {
    var tripParams, emailValidationResult, phoneNumber, phoneNumberObj, travelTime, verificationCodeLength;
  ...
  update: function update(req, res, next) {
    var tripId, tripParams, updatedTrip, trip, emailValidationResult, phoneNumber, phoneNumberObj, _updatedTrip;
  ...
  validate: function validate(req, res, next) {
    ...
    req.check("pickUpTime", "Pick up time cannot be empty").notEmpty(); // check if the address is valid
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 6:
            trip = _context8.sent;
            _context8.next = 9;
            return regeneratorRuntime.awrap(sendEmail(trip.tripUserEmail, 'Reservation Completed', 'complete', trip));
