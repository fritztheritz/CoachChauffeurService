...
const tripSchema = mongoose.Schema(
	{
	  ...
	  idempotencyKey: {type: String, required: false}, // idempotency key
	  refunded: {type: Boolean, default: false}, // trip refunded status
	  tripType: {type: String, required: false}, // trip type (was true)
	  carType: {type: String, default: "4-Passenger"}, // car type
	  priceUpdated: {type: Boolean, default: false}, // price updated status
	},
	{
	  timestamps: true,
	}
