...
router.route("/:id/delete")
  .get(userController.displayVerifyDelete)
  .post(userController.verifyDelete, userController.delete, userController.redirectView)
  .delete(userController.delete, userController.redirectView);
